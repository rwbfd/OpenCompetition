...
class OutlierDetection:
    ...
    def detect_outlier_with_extremevalues(self, df, col, method='univariate'):
        '''
        
        :param df: 
        :param col: str 
        :param method: univariate ,multiple Regression
        :return: 
        '''
...
if __name__ == '__main__':
    ...
    print(OutlierDetection().detect_outlier_with_extremevalues(df,'V1-V3-V4-V5-V7-V9',method='univariate'))
