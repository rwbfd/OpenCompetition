...
# config
flags.DEFINE_string("train_data", default=os.path.join(curr_path, "data", "ccf_data_zr_deal", "train.tsv"), help=None)
flags.DEFINE_string("dev_data", default=os.path.join(curr_path, "data", "ccf_data_zr_deal", "dev.tsv"), help=None)
flags.DEFINE_string("test_data", default=os.path.join(curr_path, "data", "ccf_data_zr_deal", "test.tsv"), help=None)
...
#                    help=None)
flags.DEFINE_string("model_config_path",
                    #"gs://pretrained-language-model/chinese/tf/chinese_xlnet_mid_L-24_H-768_A-12/xlnet_config.json",
...
flags.DEFINE_string("spiece_model_file",
                    #default="gs://pretrained-language-model/chinese/tf/chinese_xlnet_mid_L-24_H-768_A-12/spiece.model",
...
flags.DEFINE_string("tpu_name", default="node-2", help="TPU's name.")
# flags.DEFINE_string("tpu_zone", default="us-central1-a", help="TPU zone.")
# flags.DEFINE_string("tpu_address", default="10.57.43.178", help="TPU address.")
