...
class InputExample_2(object):
    ...
    def __init__(self, guid, label=None, text_a,text_b=None, noisy = None):
        self.guid = guid
        self.label = label
        self.text_a = text_a
        self.text_b = text_b
...
class InputFeatures(object):
    ...
    def __init__(self, input_ids, attention_mask=None, token_type_ids=None, label=None, noisy = None):
